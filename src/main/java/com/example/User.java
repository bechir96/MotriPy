...
public class User {
    ...
    public User(int userId, String firstName, String lastName, String email, byte[] passwordHash, byte[] passwordSalt, boolean isConfirmed, boolean isDeleted, String address, String city, String shippingAddress) {
        this.userId = userId;
